  ...
  module.exports = function(samjs) {
    ...
    return new (files = (function() {
      ...
      files.prototype.processModel = function(model) {
        var base, check, createFile, entry, file, getFile, hook, hookName, i, isFile, isFolder, j, k, l, len, len1, len2, len3, parseFile, ref, ref1, ref2, ref3, resolvePath, updateFile;
