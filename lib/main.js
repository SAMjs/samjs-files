  ...
  module.exports = function(samjs) {
    ...
    return new (Files = (function() {
      ...
      Files.prototype.processModel = function(model) {
        ...
        model.get = function(filepath, socket) {
        ...
        model.interfaces.push(function(socket) {
          return socket.on("get", function(request) {
            if ((request != null ? request.token : void 0) != null) {
              return model.get(request.content, socket).then(function(arg) {
                var data;
                data = arg.data;
                return {
                  success: true,
        ...
        model.tokens = {};
        model.getToken = function(filepath, socket) {
          return getFile(filepath).then(function(file) {
            if (!file.read) {
              new Error("no permission");
            }
        ...
        model.getByToken = function(filepath, token) {
          return getFile(filepath).then(function(file) {
            if ((model.tokens[token] != null) && model.tokens[token].path === file.path) {
              return file;
            }
        ...
        model.interfaces.push(function(socket) {
          return socket.on("getToken", function(request) {
            if ((request != null ? request.token : void 0) != null) {
              return model.getToken(request.content, socket).then(function(token) {
                return {
                  success: true,
                  content: token
                };
        ...
        model.set = function(query, socket) {
          if (query.path == null) {
            query = {
              path: null,
              data: query
        ...
        model.interfaces.push(function(socket) {
          return socket.on("set", function(request) {
            if ((request != null ? request.token : void 0) != null) {
              return model.set(request.content, socket).then(function(arg) {
                var file;
                file = arg.file;
        ...
        if (model.folders != null) {
          ...
          model["delete"] = function(query, socket) {
          ...
          model.interfaces.push(function(socket) {
            return socket.on("delete", function(request) {
              if ((request != null ? request.token : void 0) != null) {
                return model["delete"](request.content, socket).then(function(arg) {
                  var file;
                  file = arg.file;
