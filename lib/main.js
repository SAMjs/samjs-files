  ...
  module.exports = function(samjs) {
    ...
    return new (Files = (function() {
      ...
      Files.prototype.processModel = function(model) {
        var check, createFile, createFileAndCheck, entry, file, getFile, hasAuth, hasNoAuth, hook, hookName, i, isFile, isFolder, j, l, len, len1, len2, len3, m, name, options, parseFile, ref, ref1, ref2, ref3, ref4, resolvePath, updateFile;
