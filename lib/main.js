  ...
  module.exports = function(samjs) {
    ...
    return new (Files = (function() {
      ...
      Files.prototype.processModel = function(model) {
        var base, base1, base2, check, createFile, createFileAndCheck, entry, file, getFile, hasAuth, hasNoAuth, hook, hookName, i, isFile, isFolder, j, l, len, len1, len2, len3, m, name, options, parseFile, ref, ref1, ref2, ref3, ref4, resolvePath, updateFile;
        ...
        if ((base = model.access).insert == null) {
          base.insert = model.access.write;
        }
        if ((base1 = model.access).update == null) {
          base1.update = model.access.write;
        }
        if ((base2 = model.access)["delete"] == null) {
          base2["delete"] = model.access.write;
        }
